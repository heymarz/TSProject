...
// ! lets Typescript know that this is always correct
const config = (0, app_config_1.loadCongfig)();
...
app.get('/times/:stationId', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const apiCall = yield fetch(`${config === null || config === void 0 ? void 0 : config.apiUrl}?key=${config === null || config === void 0 ? void 0 : config.apiKey}&siteid=${stationId}&timewindow=60`);
